...
public final class Intersector {
	 ...
	 * constructs the triangle's plane. If the vectors t1, t2 and t3 are pointing into the same direction and if you
	 * apply the time to the point's coordinates, relative to the direction the triangle's vectors are pointing, in a
	 * right angled perspective (orthogonal projection), the projection results in an <b>infinite</b> moving stream of multiple,
	 * but little different drops.
